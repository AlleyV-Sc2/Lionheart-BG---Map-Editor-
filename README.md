...
Map editor for the Infinity Engine maps

The editor reads almost all .FRM16 and MDL16 files (FRM16), and it reads the important ones.

The decoding of some MDL16 files is not 100% accurate; due to shadows and transparency effects, some images are not displayed correctly.

I have added tools for refining objects on the map (see the keyboard shortcuts section).
